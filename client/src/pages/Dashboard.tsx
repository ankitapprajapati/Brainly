  ...
  return (
    ...
    <div className=" bg-black flex w-screen h-screen">      
      ...
      <div className="text-white grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-4 ml-52 md:ml-60 lg:ml-72 overflow-auto scrollbar-none ">
        ...
        <Card link="https://www.youtube.com/watch?v=6oEt-5AsWD8" type="youtube" title="song"/>
        <Card link="https://www.youtube.com/watch?v=6oEt-5AsWD8&list=RDS0b0tOp51q4&index=4" type="youtube" title="song"/>
       </div>
    </div>
  )
}
